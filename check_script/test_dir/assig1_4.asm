   ...
   f:	8d b5 e8 fd ff ff    	lea    -0x218(%ebp),%esi
{
  15:	53                   	push   %ebx
  16:	51                   	push   %ecx
  17:	81 ec 10 02 00 00    	sub    $0x210,%esp
  1d:	8b 79 04             	mov    0x4(%ecx),%edi
    fd = open("ls", O_RDWR);
  20:	6a 02                	push   $0x2
  22:	68 68 07 00 00       	push   $0x768
  27:	e8 d7 02 00 00       	call   303 <open>
    read(fd, buf, sizeof(buf));
  2c:	83 c4 0c             	add    $0xc,%esp
  2f:	68 00 02 00 00       	push   $0x200
    fd = open("ls", O_RDWR);
  34:	89 c3                	mov    %eax,%ebx
    read(fd, buf, sizeof(buf));
  36:	56                   	push   %esi
  37:	50                   	push   %eax
  38:	e8 9e 02 00 00       	call   2db <read>
    write(fd, buf, sizeof(buf));
  3d:	83 c4 0c             	add    $0xc,%esp
  40:	68 00 02 00 00       	push   $0x200
  45:	56                   	push   %esi
  46:	53                   	push   %ebx
  47:	e8 97 02 00 00       	call   2e3 <write>
    exec("ls", argv);
  4c:	58                   	pop    %eax
  4d:	5a                   	pop    %edx
  4e:	57                   	push   %edi
  4f:	68 68 07 00 00       	push   $0x768
  54:	e8 a2 02 00 00       	call   2fb <exec>
    close(fd);
  59:	89 1c 24             	mov    %ebx,(%esp)
  5c:	e8 8a 02 00 00       	call   2eb <close>
    exit();
  61:	e8 5d 02 00 00       	call   2c3 <exit>
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 6b 07 00 00       	mov    $0x76b,%edx
        while(*s != 0){
